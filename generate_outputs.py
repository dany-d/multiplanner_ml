...
from angle_calc import AngDiff as angle_calc
import math
...
A_star_1_0_1_runner = A_star_1_0_1.run
A_star_1_1_runner = A_star_1_1.run
A_star_1_5_runner = A_star_1_5.run
A_star_2_runner = A_star_2.run
matt_astar_runner = matt_astar.matt_astar
birrt_runner=birrt.birrt




PLANNERS = [birrt_runner, A_star_runner, A_star_1_0_1_runner, A_star_1_1_runner, A_star_1_5_runner, A_star_2_runner, matt_astar_runner]
PLANNER_NAMES = ["BiRRT","A_star","A_star_1_0_1","A_star_1_1","A_star_1_5","A_star_2", "matt_astar"]
...
def gen_outputs_directory(png_directory, save_solutions = False):
    ...
    for row_index, png_path in enumerate(png_files):
        ...
        for planner, planner_name in zip(PLANNERS, PLANNER_NAMES):
            ...
            if save_solutions:
                view_path(path, save_filepath=build_a_save_solution_filepath(planner_name, png_path))
