...
# import A_star
import A_star_steer_1_0_1
import A_star_steer_1_1
import A_star_steer_1_5
import A_star_steer_2
# import matt_astar
import birrt_steer

# A_star_runner = A_star.astar
A_star_1_0_1_runner_steer = A_star_steer_1_0_1.run
A_star_1_1_runner_steer = A_star_steer_1_1.run
A_star_1_5_runner_steer = A_star_steer_1_5.run
A_star_2_runner_steer = A_star_steer_2.run
birrt_runner_steer=birrt_steer.birrt




PLANNERS = [birrt_runner_steer, A_star_1_5_runner_steer, A_star_2_runner_steer]
PLANNER_NAMES = ["BiRRT_steer","A_star_1_5_steer","A_star_2_steer"]
